<?php
class InvoiceCatalogItemsController extends AppController {

	var $name = 'InvoiceCatalogItems';
	...
	function admin_ajax_edit($id = null) {
		...
		$catalogItems = $this->$model->CatalogItem->find('list');
		$this->set(compact('catalogItems'));
		$this->set('fields', array('invoice_id', 'quantity', 'catalog_item_id'));
