...
$( function() {
  $("input.datepicker").not('input.datetimepicker').each( function() {
...
// replace tag snippet // used further down in this file for form-responsive 
(function($){
...
$(function() {
	// used because html was upgraded to twitter bootstrap 3.0
	$('#adminNavFloManagr .container').wrap('<div class="navbar-inner" />');
...
//    });
    ...
    $('fieldset.control-group', $('.form-responsive ')).wrapInner('<tbody />').wrapInner('<table class="table table-hover" />');
   	if ( $.isFunction($.fn.replaceTagName) ) { 
    ...
    //$('.form-responsive legend').parent().hover().css('background', 'white'); // looks bad on beefjockey
