...
$(function() {
	$('.truncate').each(function(index) {
		...
		if ($(this).text().length > length) {
			$(this).after('<div class="truncated hide">' + $(this).html() + ' <a href="#" class="truncate-less">&hellip; Less</a></div>');
			$(this).html($.trim($(this).text()).substring(0, length).split(" ").slice(0, -1).join(" ") + '  <a href="#" class="truncate-more">&hellip; Read More</a>');
		}
	});
