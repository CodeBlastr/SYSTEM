 ...
 */
    ...
    $('.checkboxToggle').each(function () {
        ...
        c.wrap('<label class="toggle well header-toggle" />');
        c.after('<p><span><i class="icon-off" title="Navigation"></i></span><span><i class="icon-eye-open" title="Design"></i></span></p><a class="btn btn-mini slide-button"></a>');
        c.change(function(e){
        	toggleMode($(e.target));
        });
