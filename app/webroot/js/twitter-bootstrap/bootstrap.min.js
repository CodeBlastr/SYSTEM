...
//    });
    ...
    //$('.form-horizontal div.input').addClass('control-group');
    //$('.form-horizontal div.input label').addClass('control-label');
    //$('.form-horizontal input, .form-horizontal select, .form-horizontal .richtextarea').wrap('<div class="controls" />');
});
/* would like to make bootstrap more pluggable
$(function() {
	$("input[type=submit]").addClass("btn");
	$(".input").addClass("control-group");
	$(".input.text label").addClass("control-label");
	$(".input label ~ *").wrapAll("<div class=\"controls\" />"); 
	$(".checkbox").wrapInner("<div class=\"controls\" />"); 
	$(".submit").wrapInner("<div class=\"controls\" />"); 
});*/