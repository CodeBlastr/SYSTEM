...
$( function() {
  $( ".datepicker" ).not('.datetimepicker').each( function() {
	...
	var randomNumber = Math.ceil(Math.random()*99999)
	$( this ).wrap( '<div id="'+randomNumber+'" class="datepickers input-append" />' );
	$( this ).after( '<span class="add-on"><i data-time-icon="icon-time" data-date-icon="icon-calendar"></i></span>' );
	$( "#"+randomNumber ).datetimepicker( {
	  language: 'en',
//	  pick12HourFormat: true,
  ...
  $( ".datetimepicker" ).each( function() {
	...
	var randomNumber = Math.ceil(Math.random()*99999)
	$( this ).wrap( '<div id="'+randomNumber+'" class="datetimepickers input-append" />' );
	$( this ).after( '<span class="add-on"><i data-time-icon="icon-time" data-date-icon="icon-calendar"></i></span>' );
	$( "#"+randomNumber ).datetimepicker( {
	  language: 'en',
//	  pick12HourFormat: true,
