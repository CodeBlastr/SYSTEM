if ($("input").hasClass("nextStep")) {
	$(".nextStep").each(function(index, value) {		
		$("#formSection-" + (index + 1)).hide();
	});
	// next step clicked
	$(".nextStep").click(function(e) {
		var id = parseInt($(this).attr("id").replace("next-", ""));
		var formId = $(this).parents("form").attr("id");
		if ($("#" + formId).valid()) {
			$(".ajaxLoader").hide();
			$("#formSection-" + (id - 1)).hide("slow", function() {
				$("#formSection-" + id).show("slow");
			});
		}
		e.preventDefault();
	});
	...
	$(".previousStep").click(function(e) {
		var id = parseInt($(this).attr("id").replace("previous-", ""));
		if (id > 0) {
			$("#formSection-" + (id - 1)).hide("slow", function() {
				$("#formSection-" + (id - 2)).show("slow");
			});
		} else {
			window.history.back(); // if its the first part of the form then you can back to the previous page
		}
		e.preventDefault();
	});
}
