...
// only used in one place and its about 10 lines down  - [zuha]
// this makes kcfinder non-upgradeable (but since development stopped on it, we should be good) - [zuha]
function getUrlVars() {
	var vars = {};
...
browser.baseGetData = function(act) {
	// these two lines are where that custom function about 10 lines up is used - [zuha]
	var kcfinderuploadDir = getUrlVars()["kcfinderuploadDir"];
    var data = 'browse.php?type=' + encodeURIComponent(this.type) + '&lng=' + this.lang + '&kcfinderuploadDir=' + kcfinderuploadDir;
