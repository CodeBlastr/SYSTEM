...
$(document).bind("pageshow", function( event, ui){
	updateGrid();
	console.log('alsasdfasdfasdfasdfsdfakdjf');
});
...
var updateGrid = function () {
	$(".filterable").addClass(function() {
		...
		var letter = index[$(this).children().length];
		...
		$.each($(document).attr("data-filter-list"), function(n) {
			console.log('alskdjf');
		});
	});
}
...
$(function() { 
	...
	//  Make any select a combox by adding class="combox" http://jqueryui.com/demos/autocomplete/
	$.widget( "ui.combobox", {
		_create: function() {
			var self = this,
