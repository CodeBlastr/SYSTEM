 ...
 * @return {bool}
 */
	protected function _upgradeDatabase($queries) {
 ...
 * @return {bool}
 */
	protected function _updateSettingVersion() {
 ...
 */
	protected function _checkIfLatestVersion() {
 ...
 */
	protected function _checkFileVersion($versionDirectory) {
 ...
 * @return latest version number of files or false if directory is empty
 */
	protected function _mysqlImport($filename) {
		$prefix = '';
