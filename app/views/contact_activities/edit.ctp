...
<?php echo $form->create('ContactActivity');?>
	<fieldset>
 		<legend><?php __('Edit ContactActivity');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action' => 'delete', $form->value('ContactActivity.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('ContactActivity.id'))); ?></li>
