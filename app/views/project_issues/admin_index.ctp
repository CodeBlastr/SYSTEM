...
<?php 
$menu->setValue(array($html->link(__('Add Project', true), array('controller' => 'projects', 'action' => 'edit'), array('title' => 'Add Project', 'onclick' => 'Modalbox.show(this.href, {title: this.title, width: 500}); return false;')),$html->link(__('Add Issue', true), array('controller' => 'project_issues', 'action' => 'ajax_edit', 'project_id' => $ctrl_var['Project']['id'], 'contact_id' => $ctrl_var['Contact']['id']), array('title' => 'Add Issue for '.$ctrl_var['Project']['name'], 'onclick' => 'Modalbox.show(this.href, {title: this.title, width: 500}); return false;')),$html->link(__('Add Time', true), array('controller' => 'timesheet_times', 'action' => 'ajax_edit', 'project_id' => $ctrl_var['Project']['id']), array('title' => 'Add Time for '.$ctrl_var['Project']['name'], 'onclick' => 'Modalbox.show(this.href, {title: this.title, width: 500}); return false;')))); 
?>
