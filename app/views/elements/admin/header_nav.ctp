  <div id="header">
    <div class="middleContent">
      ...
      <div id="globalNav">
        <ul>
          <li class="first fourColumns"><a title="Business Management System" href="/admin"></a></li>
          <li class="twoColumn"> <a href="/admin/users" title="Users"><span>Users</span></a>
            <div class="sub">
              <div class="menu">
                <ul>
                ...
                <p class="other"><a href="#" title="Users Dashboard">Users Dashboard</a></p>
              </div>
            </div>
          </li>
          <li class="singleColumn"> <a href="/admin/notifications/notification_templates" title="Marketing"><span>Marketing</span></a>
            <div class="sub">
              <div class="menu">
                <ul>
                ...
                <p class="other"><a href="#" title="Marketing Dashboard">Marketing Dashboard</a></p>
              </div>
            </div>
          </li>
          <li class="fourColumns"> <a href="/admin/contacts" title="Contacts"><span>Contacts</span></a>
            <div class="sub">
              <div class="menu">
                <ul>
                ...
                <p class="other"><a href="#" title="Contacts Dashboard">Contacts Dashboard</a></p>
              </div>
            </div>
          </li>
          <li class="singleColumn"> <a href="/admin/projects" title="Projects"><span>Projects</span></a>
            <div class="sub">
              <div class="menu">
                <ul>
                ...
                <p class="other"><a href="#" title="Projects Dashboard">Projects Dashboard</a></p>
              </div>
            </div>
          </li>
          <li class="fourColumns"> <a href="/admin/catalogs"><span>Ecommerce</span></a>
            <div class="sub">
              <div class="menu">
                <ul>
                ...
                <p class="other"><a href="#" title="Ecommerce Dashboard">Ecommerce Dashboard</a></p>
              </div>
            </div>
          </li>
          <li class="fourColumns"> <a href="/admin/webpages" title="Content"><span>Content</span></a>
            <div class="sub">
              <div class="menu">
                <ul>
                ...
                <p class="other"><a href="#" title="Content Dashboard">Content Dashboard</a></p>
              </div>
            </div>
          </li>
        </ul>
