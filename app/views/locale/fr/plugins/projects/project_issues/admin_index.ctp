...
$menu->setValue(array(
	array(
		...
		'items' => array(
			$html->link(__('New Project', true), array('plugin' => 'projects', 'controller' => 'projects', 'action' => 'edit')),
			$html->link(__('New Project Issue', true), array('plugin' => 'projects', 'controller' => 'project_issues', 'action' => 'edit')),
			)
		),
	)
);
