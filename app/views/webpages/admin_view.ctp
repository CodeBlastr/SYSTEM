...
<?php
	$menu->setValue(
		array(
			...
			$html->link(__('Edit Webpage', true), array('controller' => 'webpages', 'action' => 'edit', $webpage['Webpage']['id']), array('title' => 'Edit Webpage', 'onclick' => 'Modalbox.show(this.href, {title: this.title, width: 500}); return false;')),
		)
	);
?>