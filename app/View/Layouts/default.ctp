...
<div id="siteWrap">
  <?php echo $this->Element('admin/quick_nav'); ?> <?php echo !empty($tabsElement) ? $this->Element($tabsElement.'/tabs', array(), array('plugin' => $this->request->params['plugin'])) : ''; ?>
  <div id="siteContent">
    <div id="contentWrap">
      <div id="content"> <?php echo $this->Session->flash(); ?> <?php echo $this->Session->flash('auth'); ?>
