<?php
/** 
 * This is an exact copy and always should be, and exact copy of lib/Cake/View/Helper/FormHelper.php
 * 
 * The purpose is that we want to extend this class using the convention named Form class.
 */
