...
/**
 * Auto serialization of jsonView vars
 * 
 * @var bool
 */
	public $jsonSerialize = false;
 ...
 */
	public function __construct(Controller $controller = null) {
		...
		if (isset($controller->response) && $controller->response instanceof CakeResponse) {
			...
			$this->jsonSerialize = !empty($controller->jsonSerialize) ? $controller->jsonSerialize : false;
		}
	}
 ...
 */
	public function render($view = null, $layout = null) {
		if (!empty($this->jsonSerialize)) {
			$content = json_encode($this->viewVars);
		...
		/*if (isset($this->viewVars['_serialize'])) {
			...
			$content = json_encode($this->viewVars['_serialize']);
			$this->Blocks->set('content', $content);
			return $content;
		}*/
