    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse nav-collapse">
            <ul class="nav navbar-nav">
				...
				<?php if (in_array('Transactions', CakePlugin::loaded())) { ?><li class="nav-mode"><?php echo $this->Html->link('Ecommerce', array('admin' => true, 'plugin' => 'transactions', 'controller' => 'transactions', 'action' => 'dashboard'), array('title' => 'Catalogs, Orders', 'id' => 'navProducts')); ?></li><?php } ?>
