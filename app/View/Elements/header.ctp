        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li><?php echo $this->Html->link('Contacts', '/admin/#tagContacts', array('title' => 'Leads, Opportunities', 'onclick' => 'window.location.replace(this.href);window.location.reload(true)')); ?></li>
