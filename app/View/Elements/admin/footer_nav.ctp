    ...
    <div class="gridRow">
      <div class="footerHeading">
        <ul class="loggedIn <?php if(!$this->Session->read('Auth.User')) { echo 'hide'; } ?>">
          <li><?php echo $this->Element('snpsht', array('plugin' => 'users', 'useGallery' => true, 'userId' => $this->Session->read('Auth.User.id'), 'thumbAlt' => $this->Session->read('Auth.User.username'), 'thumbTitle' => $this->Session->read('Auth.User.username'))); ?></li>
