...
$this->set('context_menu', array('menus' => array(
	array(
		'heading' => 'Webpages',
		'items' => array(
			$this->Html->link(__('List', true), array('controller' => 'webpages', 'action' => 'index'), array('class' => 'index')),
			$this->Html->link(__('New', true), array('controller' => 'webpages', 'action' => 'add'), array('class' => 'add')),
			$this->Html->link(__('Edit', true), array('controller' => 'webpages', 'action' => 'edit', $webpage['Webpage']['id']), array('class' => 'edit')),
