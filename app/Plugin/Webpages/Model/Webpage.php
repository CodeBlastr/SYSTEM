 	...
 	public function placeholder($data = null, $options = array()) {
		...
		switch ($options['type']) {
			case 'section' : 
				...
				break; 
			default : 
				$data = $this->_defaultContent();
		}
		
		if (!empty($options['create'])) {
			debug('put function to actually save the data created here');
			break;
		} else {
			return $data;
		}
