 ...
 */
 	public function placeholder($data = null, $options = array()) {
		...
		switch ($options['type']) {
			case 'section' : 
				debug('put data to return a section placeholder here');
				break; 
			default : 
