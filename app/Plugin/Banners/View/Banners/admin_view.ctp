...
<h2><?php  __('Banner');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Banner Position'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Schedule Start Date'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $banner['Banner']['schedule_start_date']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Schedule End Date'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Age Group'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Redumption Url'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
&nbsp;</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Order Payment Id');?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
	<?php echo $banner['OrderItem']['order_payment_id'];?>
&nbsp;</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Order Shipment Id');?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
	<?php echo $banner['OrderItem']['order_shipment_id'];?>
&nbsp;</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Order Transaction Id');?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
&nbsp;</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Is Virtual');?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
