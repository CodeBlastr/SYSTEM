...
<div class="indexrow">
  ...
  &nbsp;|&nbsp;<a href='javascript:void(0);' onclick="javascript:delete_job('<?php echo $jobs_details['Job']['id']; ?>');">Delete</a>&nbsp;&nbsp;&nbsp;$<?php echo $jobs_details['Job']['budget']; ?>&nbsp;&nbsp;No.of Bid: <?php echo $this->requestAction("/jobs/jobs/get_bids/{$jobs_details['Job']['id']}"); ?></div>
        </div>
