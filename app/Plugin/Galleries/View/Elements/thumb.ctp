...
$thumbWidth = $resize === false ? array() : $thumbWidth;
$thumbHeight = $resize === false ? array() : $thumbHeight;
$itemprop = array('itemprop' => 'image');
$thumbImageOptions = array_merge($thumbWidth, $thumbHeight, $thumbAlt, $thumbClass, $thumbId, $title, $itemprop);
...
// '<img src="' . $galleryThumb['GalleryThumb']['dir'] . $galleryThumb['GalleryThumb']['filename'] . '" alt="' . $thumbAlt . '">';
$conversion = $resize === false ? null : array('conversion' => $conversionType, 'quality' => 75, 'alt' => 'thumbnail'); 
if (!empty($galleryThumb['GalleryThumb']['filename'])) {
    $imagePath = $resize === false ? $galleryThumb['GalleryThumb']['dir']. '/' .$galleryThumb['GalleryThumb']['filename'] : $galleryThumb['GalleryThumb']['dir'].'thumb/'. $thumbSize .'/'.$galleryThumb['GalleryThumb']['filename'];
	...
	$image = !empty($galleryThumb['GalleryThumb']['_embed']) ? 
		...
		$this->Html->image($imagePath, $thumbImageOptions, $conversion);	
