...
<div class="row">
	<div class="well well-large pull-right last span3 col-md-4">
	...
	<div class="contacts view pull-left span8 col-md-8 first">
		<?php
		echo '<h4>Contact Details ' . $this->Html->link('Add', array('plugin' => 'contacts', 'controller' => 'contact_details', 'action' => 'add', $contact['Contact']['id']), array('class' => 'btn btn-mini btn-xs btn-primary')) . '</h4>';
		if (!empty($contact['ContactDetail'])) {
			...
			for ($i = 0; $i < count($contact['ContactDetail']); ++$i) {
				echo __('<tr><td class="span2">%s</td><td> %s %s </td></tr>', $contact['ContactDetail'][$i]['contact_detail_type'], $contact['ContactDetail'][$i]['value'],  $this->Html->link(__('Edit'), array('plugin' => 'contacts', 'controller' => 'contact_details', 'action' => 'edit', $contact['ContactDetail'][$i]['id']), array('class' => 'btn btn-mini btn-xs btn-primary')));
			}
