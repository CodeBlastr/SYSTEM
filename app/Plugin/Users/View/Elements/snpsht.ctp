...
} elseif (defined('__ELEMENT_USERS_SNPSHT')) {
	...
	<div class="descript">
		...
		<?php if ($showViewLink || $showEditLink) : ?>
			<ul>
				<?php if ($showViewLink) : ?>
					<li>
						<a href="/users/users/view/<?php echo $user['User']['id']; ?>"><strong>view my user</strong></a>
					</li>
				<?php endif; ?>
				<?php if ($showEditLink) : ?>
					<li>
						<a href="/users/users/edit/<?php echo $user['User']['id']; ?>"><strong>edit my user</strong></a>
					</li>
				<?php endif; ?>
			</ul>
		<?php endif ?>
