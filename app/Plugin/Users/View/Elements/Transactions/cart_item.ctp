...
echo  __(' %s', $this->Html->link('<i class="glyphicon glyphicon-trash">remove</i>', array('plugin' => 'transactions', 'controller' => 'transaction_items', 'action' => 'delete', $transactionItem['id']), array('title' => 'Remove from cart', 'escape' => false)));
