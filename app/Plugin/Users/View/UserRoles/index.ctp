<div class="row">
	<div class="userRoles index col-md-8">
			...
			<td><?php echo $userRole['UserRole']['id']; ?></td>
	      	...
	      	<td class="actions">
	      		...
	      		echo __('%s %s %s', 
					...
					$userRole['UserRole']['name'] != 'admin' && $userRole['UserRole']['name'] != 'guests' ? $this->Html->link(__('Duplicate', true), array('action' => 'add', $userRole['UserRole']['id']), array('class' => 'btn btn-mini')) : null,
